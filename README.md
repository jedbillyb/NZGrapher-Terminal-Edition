...
termgrapher Cars -t scatter -x Weight -y Horsepower
...
| `term/dataset.js` | CSV → `dataforselector`, upstream's column→values map |
...
```sh
git clone https://github.com/jedbillyb/termgrapher.git
cd termgrapher
npm install
